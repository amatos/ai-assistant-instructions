---
name: secrets-policy
description: No secrets, person-specific defaults, or private-repo IDs in commits. Cross-repo PUBLIC docs go to docs.alberthmatos.com. Use placeholders for anything tied to one user.
---
...
[`docs.alberthmatos.com`](https://docs.alberthmatos.com)
(source: [`github.com/amatos/docs`](https://github.com/amatos/docs)).
