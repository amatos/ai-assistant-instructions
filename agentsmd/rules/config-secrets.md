...
- [Security overview](https://docs.alberthmatos.com/security/overview)
  — decision tree, which tool for which secret.
- [Golden laws](https://docs.alberthmatos.com/security/golden-laws)
  — the 15 non-negotiable rules. This file is one of their implementations.
- Per-tool deep dives:
  [Doppler](https://docs.alberthmatos.com/security/tools/doppler),
  [macOS Keychain](https://docs.alberthmatos.com/security/tools/macos-keychain),
  [AWS Vault](https://docs.alberthmatos.com/security/tools/aws-vault),
  [SOPS](https://docs.alberthmatos.com/security/tools/sops),
  [Bitwarden](https://docs.alberthmatos.com/security/tools/bitwarden),
  [BWS](https://docs.alberthmatos.com/security/tools/bws),
  [OpenBao](https://docs.alberthmatos.com/security/tools/openbao).
